    ...
    <nav class="nav_main">
        <div class="nav-main__content ">
            ...
            <div class="nav-main__search">
                <input class="nav-main__input" type="text" placeholder="">
                <div class="nav-main__input-span">
                    <span>
                        Поиск
                    </span>
                </div>
            ...
            <div class="nav-main__icon-container">
                <div class="nav_main__icon">
                    <svg aria-label="Главная страница" fill="#262626" height="22" role="img" viewBox="0 0 48 48" width="22">
                ...
                <div class="nav_main__icon">
                    <svg aria-label="Messenger" fill="#262626" height="22" role="img" viewBox="0 0 48 48" width="22">
                ...
                <div class="nav_main__icon">
                    <svg aria-label="Найти людей" fill="#262626" height="22" role="img" viewBox="0 0 48 48" width="22">
                ...
                <div class="nav_main__icon">
                    <img class="nav_main__avatarka" src="src/img/225848016_315960166898532_6526313692072403850_n.jpg" />
                </div>
            </div>
        </div>
    </nav>
    <main class="main">
        <div class="main-section">
            ...
            <aside class="main-section__aside">
                <div class="main-section__profile-section">
                </div>
            </aside>
        </div>
    </main>
